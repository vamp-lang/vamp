...
pub fn eval(expr: &Expr) -> Result<Value> {
    match &expr.kind {
        ...
        ExprKind::BinOp(binary_op, l, r) => match binary_op {
            ...
            BinOp::NotEq => match (eval(l)?, eval(r)?) {
                (Value::Bool(a), Value::Bool(b)) => Ok(Value::Bool(a != b)),
                (Value::Sym(a), Value::Sym(b)) => Ok(Value::Bool(a != b)),
                (Value::Str(a), Value::Str(b)) => Ok(Value::Bool(a != b)),
                (Value::Int(a), Value::Int(b)) => Ok(Value::Bool(a != b)),
            ...
            BinOp::Lt => match (eval(l)?, eval(r)?) {
                (Value::Str(a), Value::Str(b)) => Ok(Value::Bool(a < b)),
                (Value::Int(a), Value::Int(b)) => Ok(Value::Bool(a < b)),
                (Value::Float(a), Value::Float(b)) => Ok(Value::Bool(a < b)),
                _ => Err(Error::Types),
            },
            BinOp::LtEq => match (eval(l)?, eval(r)?) {
                (Value::Str(a), Value::Str(b)) => Ok(Value::Bool(a <= b)),
                (Value::Int(a), Value::Int(b)) => Ok(Value::Bool(a <= b)),
                (Value::Float(a), Value::Float(b)) => Ok(Value::Bool(a <= b)),
                _ => Err(Error::Types),
            },
            BinOp::Gt => match (eval(l)?, eval(r)?) {
                (Value::Str(a), Value::Str(b)) => Ok(Value::Bool(a > b)),
                (Value::Int(a), Value::Int(b)) => Ok(Value::Bool(a > b)),
                (Value::Float(a), Value::Float(b)) => Ok(Value::Bool(a > b)),
                _ => Err(Error::Types),
            },
            BinOp::GtEq => match (eval(l)?, eval(r)?) {
                (Value::Str(a), Value::Str(b)) => Ok(Value::Bool(a >= b)),
                (Value::Int(a), Value::Int(b)) => Ok(Value::Bool(a >= b)),
                (Value::Float(a), Value::Float(b)) => Ok(Value::Bool(a >= b)),
                _ => Err(Error::Types),
            },
            BinOp::And => match eval(l)? {
            ...
            BinOp::Or => match eval(l)? {
                Value::Bool(true) => Ok(Value::Bool(true)),
                Value::Bool(false) => match eval(r)? {
                    Value::Bool(value) => Ok(Value::Bool(value)),
                    _ => Err(Error::Types),
                },
                _ => Err(Error::Types),
